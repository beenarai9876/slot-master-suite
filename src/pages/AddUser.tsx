...
const AddUser: React.FC = () => {
  ...
  const supervisors = [
    { id: '2', name: 'John Supervisor', department: 'Engineering' },
    { id: '5', name: 'Dr. Sarah Wilson', department: 'Computer Science' },
    { id: '6', name: 'Prof. Michael Chen', department: 'Engineering' },
  ];
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => handleInputChange('userType', value as UserFormData['userType'])}
                >
                  <SelectTrigger>
          ...
          <div className="grid gap-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Full system access. Can manage all users, equipment, and system settings.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Can browse equipment, request bookings, and view personal booking history. 
